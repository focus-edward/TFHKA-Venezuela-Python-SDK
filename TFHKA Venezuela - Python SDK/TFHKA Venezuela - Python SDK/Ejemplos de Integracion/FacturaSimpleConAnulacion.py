"""
EJEMPLO DE INTEGRACIÓN PARA GENERAR FACTURA SIMPLE CON ANULACION - (PYTHON 3)
...
* PASO 2
.........................................................................................................................
     DEFINIR LA INFORMACIÓN QUE VA UTILIZAR PARA GENERAR FACTURA SIMPLE CON ANULACION
...
* PASO 4
.........................................................................................................................
     UTILIZAR LOS MÉTODOS Y ATRIBUTOS QUE EL OFRECE LA LIBRERIA PARA GENERAR FACTURA SIMPLE CON ANULACION
...
class FacturaSimpleConAnulacion():
    ...
    COMMAND_CANCEL = "7"                                    # Comando para Anular Factura
    ...
    try:
        ...
        if PortOpen:
            ...
            Respuesta = Printer.SendCmd(COMMAND_CANCEL)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_CANCEL)
            else: print("*** Comando Enviado: " + COMMAND_CANCEL)
