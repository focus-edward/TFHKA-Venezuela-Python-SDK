"""
EJEMPLO DE INTEGRACIÓN PARA GENERAR FACTURA SIMPLE CON DESCUENTO - (PYTHON 3)
...
* PASO 2
.........................................................................................................................
     DEFINIR LA INFORMACIÓN QUE VA UTILIZAR PARA GENERAR FACTURA SIMPLE CON DESCUENTO
...
* PASO 4
.........................................................................................................................
     UTILIZAR LOS MÉTODOS Y ATRIBUTOS QUE EL OFRECE LA LIBRERIA PARA GENERAR FACTURA SIMPLE CON DESCUENTO
...
class FacturaSimple():
    ...
    COMMAND_DES_PORCENTAJE = "p-0300"                       # Comando de Descuento por Porcentaje Factura
    COMMAND_DES_MONTO = "q-000000010"                       # Comando de Descuento por Monto  Factura
    ...
    try:
        ...
        if PortOpen:
            ...
            Respuesta = Printer.SendCmd(COMMAND_DES_PORCENTAJE)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_DES_PORCENTAJE)
            else: print("*** Comando Enviado: " + COMMAND_DES_PORCENTAJE)

            Respuesta = Printer.SendCmd(COMMAND_DES_MONTO)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_DES_MONTO)
            else: print("*** Comando Enviado: " + COMMAND_DES_MONTO)
