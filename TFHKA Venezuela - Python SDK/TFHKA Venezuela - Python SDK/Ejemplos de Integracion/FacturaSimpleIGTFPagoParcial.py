"""
EJEMPLO DE INTEGRACIÓN PARA GENERAR FACTURA DE PAGO PARCIAL SIMPLE CON IGTF - (PYTHON 3)
...
* PASO 2
.........................................................................................................................
     DEFINIR LA INFORMACIÓN QUE VA UTILIZAR PARA GENERAR FACTURA PAGO PARCIAL CON IGTF
...
* PASO 4
.........................................................................................................................
     UTILIZAR LOS MÉTODOS Y ATRIBUTOS QUE EL OFRECE LA LIBRERIA PARA GENERAR FACTURA PAGO PARCIAL CON IGTF.
...
class FacturaSimpleIGTFPagoParcial():
    ...
    PLU3 = '"000000001000001000Producto 3'                  # Información  de PLU: Tasa Reducida, cantidad 1, monto 0.10 bs, nombre del PLU
    PLU4 = "#000000001000001000Producto 4"                  # Información  de PLU: Tasa Ampliada, cantidad 1, monto 0.10 bs, nombre del PLU

    COMMAND_SUBTOTAL = "3"                                  # Comando de subtotal de factura
    COMMAND_FLAG50 = "PJ5001"                               # Comando para establecer el Flag 50 en 01
    COMMAND_PAGOPARCIAL_FIRST = "220000000000010"           # Comando del Primer Pago Parcial Factura
    COMMAND_PAGOPARCIAL_SEC = "221000000000010"             # Comando del Segundo Pago Parcial Factura
    COMMAND_PAGOTOTAL = "101"                               # Comando de Totalizar con medio de pago 01 en moneda nacional
    COMMAND_CLOSEINVOCE = "199"                                   # Comando de Cierre Factura igtf
    COMMAND_COMMENT = "@EJEMPLO DE IGTF"                   # Comando envio para Introducir un comentario
    ...
    try:
        ...
        if PortOpen:
            ...
            Respuesta = Printer.SendCmd(COMMAND_PAGOPARCIAL_FIRST)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_PAGOPARCIAL_FIRST)
            else: print("*** Comando Enviado: " + COMMAND_PAGOPARCIAL_FIRST)

            Respuesta = Printer.SendCmd(COMMAND_PAGOPARCIAL_SEC)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_PAGOPARCIAL_SEC)
            else: print("*** Comando Enviado: " + COMMAND_PAGOPARCIAL_SEC)
            ...
            Respuesta = Printer.SendCmd(COMMAND_CLOSEINVOCE)
            if not Respuesta: print("Comando No Aceptado: " + COMMAND_CLOSEINVOCE)
            else: print("*** Comando Enviado: " + COMMAND_CLOSEINVOCE)
